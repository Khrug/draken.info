...
The global sheaf coherence is computed by treating the knowledge graph as a cellular sheaf and measuring the sheaf Laplacian (where low values indicate high convergence Γ — distinct from the psychosis metric Ψ, which tracks the inverse):
...
*Internal cross-references: [The Kaiju Manifesto](/posts/kaiju-manifesto/) (DRK-105), [The Thermodynamics of Affect](/posts/thermodynamics-of-affect/) (DRK-112).*
