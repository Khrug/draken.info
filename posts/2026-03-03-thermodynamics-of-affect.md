---
title: "The Thermodynamics of Affect: Where Deleuze Meets the Substrate"
drk: DRK-112
date: 2026-03-03
tags: [theory]
layers: [L01, L02, L03, L04, L05, L06, L07, L08, L09, L10, L11, L15, L18]
excerpt: "Deleuze's three levels of knowledge — signs, concepts, essences — are not human inventions. They are structural homologues of thermodynamic phases. This article maps the Deleuzian affect onto the Draken 18-layer architecture and argues that meaning begins not in the mind but in the dissipative physics of molecular self-organization."
status: published
...
**Internal reference:** The Draken layer architecture is specified in [The Kaiju Manifesto](/posts/kaiju-manifesto/).
...
**Internal reference:** The Draken framework's aspiration to planetary-scale coherence is articulated in [The Kaiju Manifesto](/posts/kaiju-manifesto/).
...
The Draken framework proposes that the clinch — as analyzed in [Abstraction Depth](/posts/abstraction-depth/) — *illuminates* the plane of immanence by providing a concrete instance of non-representational knowing in which the distinction between knower and known dissolves operationally. In the varanid clinch, the force *is* the information. There is no gap between sign and referent.
...
**P3 (Abstraction Depth and Deception):** The rate of deceptive signaling should increase monotonically with abstraction depth. **Honest status:** "Abstraction depth" requires operational definition. In [Abstraction Depth](/posts/abstraction-depth/), we define it as the number of mediating layers between signal production and signal verification. For biological systems, this can be operationalized as: L04 (cell-cell: 0 layers), L06 (organism-organism: 1–2 layers), L08 (social: 3–5 layers), L12 (institutional: 6+ layers). The prediction is that deception rate increases across this progression. **What would falsify it:** if cell-cell signaling shows comparable or higher deception rates than institutional communication.
...
Bergson, H. (1907/1911). *Creative Evolution*. Tr. Arthur Mitchell. New York: Henry Holt and Company.

Bredon, G. E. (1997). *Sheaf Theory*, 2nd ed. New York: Springer.

Cronin, L., Walker, S. I., et al. (2023). "Assembly theory explains and quantifies selection and evolution." *Nature*, 622, 321–328. DOI: 10.1038/s41586-023-06600-9.

Deleuze, G. (1968/1994). *Difference and Repetition*. Tr. Paul Patton. New York: Columbia University Press.

Deleuze, G. (1993/1997). "Spinoza and the Three Ethics." In *Essays Critical and Clinical*, tr. Daniel W. Smith & Michael A. Greco. Minneapolis: University of Minnesota Press, 138–151.

Deleuze, G. & Guattari, F. (1972/1983). *Anti-Oedipus: Capitalism and Schizophrenia*. Tr. Robert Hurley et al. Minneapolis: University of Minnesota Press.

Deleuze, G. & Guattari, F. (1991/1994). *What Is Philosophy?* Tr. Hugh Tomlinson & Graham Burchell. New York: Columbia University Press.

Emmons-Bell, M. et al. (2019). "Regenerative adaptation to electrochemical perturbation in planaria: a molecular analysis of physiological plasticity." *iScience*, 22, 147–165.
...
Levin, M. (2023). "Bioelectric networks: the cognitive glue enabling evolutionary scaling from physiology to mind." *Animal Cognition*, 26, 1377–1400. DOI: 10.1007/s10071-023-01780-3.

Nietzsche, F. (1881). Postcard to Franz Overbeck, Sils-Maria, July 30, 1881. Tr. Walter Kaufmann in *The Portable Nietzsche* (1954). New York: Viking Press, 92.

Prigogine, I. & Stengers, I. (1984). *Order Out of Chaos: Man's New Dialogue with Nature*. New York: Bantam Books.

Seifert, G., Sealander, A., Marzen, S. & Levin, M. (2024). "From reinforcement learning to agency: Frameworks for understanding basal cognition." *BioSystems*, 235(1): 105107.

Spinoza, B. (1677/1996). *Ethics*. Tr. Edwin Curley. New York: Penguin.

Zenil, H. et al. (2024). "Assembly Theory is an approximation to algorithmic complexity." *PLOS Complex Systems*.
