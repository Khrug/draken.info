---
title: "The Pendragon Source"
drk: DRK-165
date: 2026-06-22
tags: [etymology, varanid, historiography, toxicofera, anti-totalisation]
layers: [L01, L09, L18]
coherence: 0.71
...
sources:
  - "Geoffrey of Monmouth (c. 1136). *Historia Regum Britanniae.* (Coining of the 'dragon's head' etymology and the dragon-comet origin for Uther's epithet.)"
  - "Uther Pendragon — Middle Welsh *pen* 'head, chief' + *dragon* (poetic 'warriors', from Latin pl. *dracones*); epithet 'leader of warriors', misinterpreted by Geoffrey as 'head of a dragon'. (Standard philological reading; see etymonline 'pendragon', and the *pen* < Proto-Celtic *kʷennom* 'head' entry.)"
  - "Harper, D. *Online Etymology Dictionary* — entries 'pendragon', 'pen (n.2 / writing)' < Latin *penna* 'feather, quill'; 'history' < Gk *historía* < *hístōr* 'witness, knowing one' < PIE *wid-tor-, root *weid- 'to see, know'; 'tale' (OE *talu*, account/reckoning) and 'tail' (OE *tægl*) as separate roots."
  - "Fry, B.G., Vidal, N., et al. (2006). Early evolution of the venom system in lizards and snakes. *Nature* 439, 584–588. (Single origin of venom; Toxicofera = Serpentes + Anguimorpha + Iguania, ~170–200 Mya.)"
  - "Vidal, N., Hedges, S.B. (2005). The phylogeny of squamate reptiles (lizards, snakes, and amphisbaenians) inferred from nine nuclear protein-coding genes. *C. R. Biologies* 328, 1000–1008."
  - "Hargreaves, A.D., Tucker, A.S., Mulley, J.F. (2015). A critique of the Toxicofera hypothesis. In *Evolution of Venomous Animals and Their Toxins.* Springer. (Dissent: hypothesis unsupported on anatomical + non-toxin sequence grounds.)"
  - "Kardong, K.V.; Weinstein, S.A.; Smith, T.L. — on the many biological roles of reptilian oral secretions beyond prey capture (caution against over-reading 'venom')."
  - "LeBlanc, A.R.H., MacDougall, M.J., Haridy, Y., Scott, D., Reisz, R.R. (2018). Caudal autotomy as anti-predatory behaviour in Palaeozoic reptiles. *Scientific Reports* 8, 3328. DOI: 10.1038/s41598-018-21526-3. (Oldest known autotomy: Early Permian captorhinids.)"
  - "On varanid tails: monitor lizards lack caudal autotomy; the tail is retained as weapon, prop, and (in arboreal species) prehensile organ — contrast with autotomising tegus and iguanians."
